import 'package:arcore/screens/augmented_faces.dart';
import 'package:arcore/screens/augmented_images.dart';
import 'package:arcore/screens/image_object.dart';
import 'package:arcore/screens/matri_3d.dart';
import 'package:arcore/screens/multiple_augmented_images.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('ArCore Demo')),
      body: ListView(
        children: <Widget>[
          ListTile(
            onTap: () {
          ...
          ListTile(
            onTap: () {
              Navigator.of(
                context,
              ).push(MaterialPageRoute(builder: (context) => AssetsObject()));
            },
